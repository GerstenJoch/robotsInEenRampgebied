...
void setup() {
  ...
  int isButtonPressed = 0;    //Set button status to "0", aka false; the button has not been pressed before, or has been set to status "0"
}

void loop() {
  fsrReading = analogRead(fsrAnalogPin);
  
  if (int isButtonPressed = 0 && fsrReading > 100) {
  ...
  else if (int isButtonPressed = 1 && fsrReading > 100) {
